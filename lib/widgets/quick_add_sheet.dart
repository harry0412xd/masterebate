      ...
      child: StatefulBuilder(
        builder: (ctx, setModalState) {
          ...
          if (selectedCardName != null) {
            ...
            percentCtrl.text = sel != null ? sel.rebatePct.toString() : card.extraRebatePct.toString();
          }
            ...
            children: [
              ...
              FilledButton(
                onPressed: () {
                  ...
                  provider.addExpense(amt, desc, saveAsPreset: false, rebatePct: pct);
